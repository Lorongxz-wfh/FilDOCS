...
const TemplatesPage: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="rounded-md border border-slate-200 dark:border-surface-400 bg-white dark:bg-surface-500">
          {/* Card header */}
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-surface-400 bg-slate-50 dark:bg-surface-600 px-4 py-3">
            <div>
          ...
          {/* ── Filter toolbar ── */}
          <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 dark:border-surface-400 px-4 py-3">
            {/* Search */}
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-200 dark:border-surface-400 bg-white dark:bg-surface-500 pl-8 pr-8 py-1.5 text-sm text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900/30 transition"
              />
              {q && (
                <button
                  type="button"
            ...
            <div ref={tagDropdownRef} className="relative">
              ...
              {tagDropdownOpen && (
                <div className="absolute left-0 top-full mt-1.5 z-20 w-52 rounded-md border border-slate-200 dark:border-surface-400 bg-white dark:bg-surface-600 shadow-md overflow-hidden">
                  <div className="px-3 py-2 border-b border-slate-200 dark:border-surface-400">
              ...
              loading ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                  {Array.from({ length: 10 }).map((_, i) => (
                    <div
                      key={i}
                      className="rounded-md bg-slate-100 dark:bg-surface-600 animate-pulse aspect-3/4"
                    />
                  ))}
                </div>
              ) : filtered.length === 0 ? (
                <div className="rounded-md border border-dashed border-slate-200 dark:border-surface-400 bg-slate-50 dark:bg-surface-600 px-6 py-10 text-center">
      ...
      >
        <div className="mb-4 rounded-md border border-slate-200 dark:border-surface-400 bg-slate-50 dark:bg-surface-600 px-4 py-3 text-xs text-slate-600 dark:text-slate-400 space-y-1">
