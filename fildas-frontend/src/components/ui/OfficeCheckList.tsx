...
const OfficeCheckList: React.FC<OfficeCheckListProps> = ({
  ...
  return (
    <div className="rounded-md border border-slate-200 dark:border-surface-400 bg-white dark:bg-surface-500 overflow-hidden shadow-sm">
                  ...
                  {multi ? (
                    <span
                      className={[
                        ...
                        isSelected
                          ? "bg-slate-900 border-slate-900 dark:bg-slate-100 dark:border-slate-100 shadow-sm"
                    ...
                    >
                      {isSelected && (
                        <span className="h-1.5 w-1.5 rounded-full bg-slate-900 dark:bg-slate-100 shadow-sm" />
                      )}
                    </span>
                  )}
