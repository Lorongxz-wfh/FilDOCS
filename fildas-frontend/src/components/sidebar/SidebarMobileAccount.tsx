    ...
    <div className="shrink-0 px-4 pt-5 pb-4 space-y-4 border-b border-slate-100 dark:border-surface-400 bg-slate-50/30 dark:bg-black/5">
      <div className="flex items-center gap-3">
        <div className="h-11 w-11 rounded-full bg-brand-500 p-0.5 border border-white/20 shadow-md">
          <div className="h-full w-full rounded-full overflow-hidden flex items-center justify-center text-white text-sm font-semibold bg-brand-600">
...
<NavLink
  ...
  className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white dark:bg-surface-400 border border-slate-200 dark:border-white/5 active:scale-95 transition-all  overflow-hidden"
>
